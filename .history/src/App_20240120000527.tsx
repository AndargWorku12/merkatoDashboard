...
const App: React.FC = () => {
  ...
  const orders: Order[] = [
    ...
    { id: '3', product: products[4], quantity: 3 },
    { id: '4', product: products[6], quantity: 2 },
    { id: '5', product: products[8], quantity: 1 },
    { id: '6', product: products[1], quantity: 2 },
    { id: '7', product: products[3], quantity: 3 },
    { id: '8', product: products[5], quantity: 1 },
    { id: '9', product: products[7], quantity: 2 },
    { id: '10', product: products[9], quantity: 1 },
  ];
  ...
  const reviews: Review[] = [
    { id: '1', text: 'Great product!', rating: 5, commit:'am not happy this product' },
    { id: '2', text: 'Good quality.', rating: 4, commit:'am not happy this product' },
    { id: '3', text: 'Excellent service.', rating: 5, commit:'am not happy this product' },
    { id: '4', text: 'Not satisfied with the product.', rating: 2, commit:'am not happy this product' },
    { id: '5', text: 'Fast shipping!', rating: 5, commit:'am not happy this product' },
    { id: '6', text: 'Average product.', rating: 3, commit:'am not happy this product' },
    { id: '7', text: 'Outstanding experience.', rating: 5, commit:'am not happy this product' },
    { id: '8', text: 'Prompt delivery.', rating: 4, commit:'am not happy this product' },
    { id: '9', text: 'Poor customer service.', rating: 2, commit:'am not happy this product' },
    { id: '10', text: 'Love it!', rating: 5, commit:'am not happy this product' },
  ];
