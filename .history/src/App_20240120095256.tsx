...
const App: React.FC = () => {
  ...
  const orders: Order[] = [
    { id: '1', product: product[0], quantity: 2, totalPrice:234 },
    { id: '2', product: product[2], quantity: 1, totalPrice:234  },
    { id: '3', product: product[4], quantity: 3, totalPrice:234  },
    { id: '4', product: product[6], quantity: 2, totalPrice:234  },
    { id: '5', product: product[8], quantity: 1, totalPrice:234  },
    { id: '6', product: product[1], quantity: 2, totalPrice:234  },
    { id: '7', product: product[3], quantity: 3, totalPrice:234  },
    { id: '8', product: product[5], quantity: 1, totalPrice:234  },
    { id: '9', product: product[7], quantity: 2, totalPrice:234  },
    { id: '10', product: product[9], quantity: 1, totalPrice:234  },
  ];
