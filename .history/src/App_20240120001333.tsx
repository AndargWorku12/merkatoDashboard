...
const App: React.FC = () => {
  ...
  const reviews: Review[] = [
    { id: '1', text: 'Great product!', commit:'am happy', rating: 5 },
    { id: '2', text: 'Good quality.',  commit:'am happy', rating: 4 },
    { id: '3', text: 'Excellent service.',  commit:'am happy', rating: 5 },
    { id: '4', text: 'Not satisfied with the product.',  commit:'am happy', rating: 2 },
    { id: '5', text: 'Fast shipping!',  commit:'am happy', rating: 5 },
    { id: '6', text: 'Average product.',  commit:'am happy', rating: 3 },
    { id: '7', text: 'Outstanding experience.',  commit:'am happy', rating: 5 },
    { id: '8', text: 'Prompt delivery.',  commit:'am happy', rating: 4 },
    { id: '9', text: 'Poor customer service.',  commit:'am happy', rating: 2 },
    { id: '10', text: 'Love it!',  commit:'am happy', rating: 5 },
  ];
    ...
    <BrowserRouter>
      <Sidebar>
        <Routes>
          ...
          <Route path="/analytics" element={<Analytics salesData={salesData} />} />
