...
// for the product page to handle
  ...
  const createProduct = (product: any) => Promise.resolve();
  const deleteProduct = (id: string) => Promise.resolve();
  const updateProduct = (id: string, newName: string, newPrice: number, newImage: string) => Promise.resolve();
