...
const App: React.FC = () => {
  ...
  const reviews: Review[] = [
    ...
    { id: '4', text: 'Not satisfied with the product.', rating: 2 },
    { id: '5', text: 'Fast shipping!', rating: 5 },
    { id: '6', text: 'Average product.', rating: 3 },
    { id: '7', text: 'Outstanding experience.', rating: 5 },
    { id: '8', text: 'Prompt delivery.', rating: 4 },
    { id: '9', text: 'Poor customer service.', rating: 2 },
    { id: '10', text: 'Love it!', rating: 5 },
  ];
