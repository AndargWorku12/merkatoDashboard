...
const App: React.FC = () => {
  ...
  return (
    ...
    <Sidebar>
      <Routes>
        <Route path="/" element={<Dashboard saleData={SaleDat} revenueData={revenueData} />} />
        <Route path="/dashboard" element={<Dashboard saleData={SaleDat} revenueData={revenueData} />} />
        <Route path="/login" element={<Login />} />
        <Route path="/signup" element={<Signup />} />
        <Route path="/review" element={<CustemerReview reviews={reviews} />} />
        <Route path="/analytics" element={<Analytics saleData={SaleDat} />} />
