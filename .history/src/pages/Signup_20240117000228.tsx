import {
  ...
  const Signup = () => {
    return (
      ...
      >
        <Stack direction="row" spacing="12" className="showcase-1idc0c1">
          <Container className="showcase-13pmxen">
            <Container className="showcase-49waov">
              <Stack className="showcase-18936vg">
                <Stack className="showcase-1urha0v">
                  <svg
                    viewBox="0 0 89 89"
                ...
                <Stack className="showcase-ahthbn">
                  ...
                  <Stack className="showcase-1kxonj9" role="group">
                    ...
                    <input type="text" id="name" required="" aria-required="true" className="showcase-1pmfxiu" />
                  </Stack>
        ...
        <Container className="showcase-129mlto">
          <Stack className="showcase-abvxnf">
            ...
            <Stack className="showcase-o51fhk">
              <Avatar className="showcase-bs24kp" src="https://avatars.githubusercontent.com/u/20296626?v=4" alt="Simon Holzmayer">
