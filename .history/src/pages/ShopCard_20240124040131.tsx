        ...
        <div className="rounded overflow-hidden shadow-lg flex flex-col">
          <div className="relative">
            <a href="#">
              <img
                className="w-full"
                src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fblog.bonfire.com%2Ft-shirt-design-trends%2F&psig=AOvVaw186C4lQNciGsReATMs103M&ust=1706183834645000&source=images&cd=vfe&opi=89978449&ved=0CBMQjRxqFwoTCNjVv6789YMDFQAAAAAdAAAAABAL w-500"
                alt="Sunset in the mountains"
              />
              <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
            </a>
