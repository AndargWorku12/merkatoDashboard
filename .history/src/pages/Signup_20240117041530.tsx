import {
  ...
  interface ExtendedSettingsIconProps extends OriginalSettingsIconProps {
    size: string;
}
             ...
             <Text 
              ...
              data-orientation="horizontal">
                    ...
                    >
                      ...
                      <SettingsIcon size="1em" display="inline-block" lineHeight="1em" flexShrink="0" color="yourColor" verticalAlign="yourAlign" />
  ...
  gap="8">
            ...
            >
              ...
              <Flex className="showcase-7zp8no"
              align="center"
              direction="row"
              gap="0.5rem"
              >
                ...
                {[...Array(4)].map((_, index) => (
                  <Icon key={index} viewBox="0 0 576 512" focusable="false" className="showcase-1mju1or"
